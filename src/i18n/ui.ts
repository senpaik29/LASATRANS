...
export const ui = {
  cs: {
    ...
    "quote.form.datePlaceholder": "DD/MM/RRRR",
    "quote.form.datePickerLabel": "Otevřít kalendář",
    "quote.form.dateInvalid": "Zadejte prosím datum ve formátu DD/MM/RRRR.",
  ...
  en: {
    ...
    "quote.form.datePlaceholder": "DD/MM/YYYY",
    "quote.form.datePickerLabel": "Open calendar",
    "quote.form.dateInvalid": "Please enter the date in DD/MM/YYYY format.",
